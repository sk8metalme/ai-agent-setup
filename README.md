...
| `guardrail-builder` | 会話履歴から自動学習し.claude/rules/guardrail.mdに保存<br>自動読み込み、繰り返しミス防止 | 📚スキル: 1個 | guardrail, learning, rules, memory |
...
- **guardrail-builder**: 会話履歴から自動学習、.claude/rules/guardrail.md更新（自動読み込み）
