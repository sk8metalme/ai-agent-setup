...
| `guardrail-builder` | 会話履歴から自動学習しCLAUDE-guardrail.mdに追記<br>繰り返しミス防止、プロジェクト知識の蓄積 | 📚スキル: 1個<br>🪝フック: 1個 | guardrail, learning, automation, claude-md, session-end |
...
- **guardrail-builder**: 会話履歴から自動学習、CLAUDE-guardrail.md更新
